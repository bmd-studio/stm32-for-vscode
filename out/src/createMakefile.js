...
function _getMakefile() {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(makefileInfo, fileList) {
    var totalInfo, makeFile;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            totalInfo = bundleInfo(makefileInfo, fileList);
            totalInfo = checkAndConvertCpp(totalInfo);
            makeFile = convertTemplate(totalInfo);
            return _context.abrupt("return", makeFile);
