...
(0, _mocha.suite)('CreateMakefile test', function () {
  ...
  (0, _mocha.test)('combineArraysIntoObject', function () {
    ...
    _assert["default"].deepEqual((0, _CreateMakefile.combineArraysIntoObject)(array1, array2, 'theKey', {}), {
      theKey: array2.concat(array1).sort()
    }); // test if it handles duplication in the arrays correctly


    _assert["default"].deepEqual((0, _CreateMakefile.combineArraysIntoObject)(array1, array1, 'entry', {}), {
      entry: array1.sort()
    }); // test if it handles none array input correctly


    _assert["default"].deepEqual((0, _CreateMakefile.combineArraysIntoObject)(array1, null, 'entry', {}), {
      entry: array1.sort()
    });

    _assert["default"].deepEqual((0, _CreateMakefile.combineArraysIntoObject)(null, array1, 'entry', {}), {
      entry: array1.sort()
    });

    _assert["default"].deepEqual((0, _CreateMakefile.combineArraysIntoObject)(null, null, 'entry', {}), {
      entry: []
    });

    _assert["default"].deepEqual((0, _CreateMakefile.combineArraysIntoObject)(array1, {}, 'entry', {}), {
      entry: array1.sort()
    });

    _assert["default"].deepEqual((0, _CreateMakefile.combineArraysIntoObject)({}, null, 'entry', {}), {
      entry: []
    });

    _assert["default"].deepEqual((0, _CreateMakefile.combineArraysIntoObject)({}, array2, 'entry', {}), {
      entry: array2.sort()
    });
  });
  (0, _mocha.test)('bundleInfo', function () {
    _assert["default"].deepEqual((0, _CreateMakefile.bundleInfo)(testMakeFile, testList), totalMakeFileInfo);
  });
  (0, _mocha.test)('checkAndConvertCpp', function () {
    ...
    _assert["default"].deepEqual((0, _CreateMakefile.checkAndConvertCpp)(justC), justC); // check if it removes the cpp entries if there is only a main.c
    ...
    _assert["default"].deepEqual((0, _CreateMakefile.checkAndConvertCpp)(extraCPP), justC); // check if it converts to cpp when both main.c and main.cpp are there
    ...
    _assert["default"].deepEqual((0, _CreateMakefile.checkAndConvertCpp)(cppWithMainC), cpp);
  });
});