...
configuration.linkerScript = 'STM32F769IITx_FLASH.ld';
configuration.openocdTarget = 'stm32f7x';
configuration.cDefinitions = configuration.cDefinitions.concat(['STM32F769xx', 'USE_HAL_DRIVER']);
configuration.libraryDirectories = ['libraryDirectories_1', 'libraryDirectories_2', 'libraryDirectories_3'];
