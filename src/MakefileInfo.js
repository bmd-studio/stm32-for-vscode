 ...
 */
/* eslint no-param-reassign: ["error", { "props": true, "ignorePropertyModificationsFor": ["infoDef"] }] */
 ...
 */
async function getMakefile(location) {
 ...
 */
async function getMakefileInfo(location) {
