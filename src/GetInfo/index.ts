...
//         combinedInfo.cSources = stripIgnoredFiles(info.cSources, ignores);
//         combinedInfo.cxxSources = stripIgnoredFiles(info.cxxSources, ignores);
//         combinedInfo.asmSources = stripIgnoredFiles(info.asmSources, ignores);
//         resolve(info);
//       });
//     }).catch((err) => {
